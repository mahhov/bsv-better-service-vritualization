...
bsv.registerPromise = function (name, object, method) {
    ...
    object[method] = function () {
        ...
        return modePromise.then(function (mode) {
            if (mode === modes.RECORD) return recordPromise.apply(undefined, [name, oldMethod, _this].concat(Array.prototype.slice.call(_arguments)));else if (mode === modes.REPLAY) return replayPromise(name, oldMethod);else return oldMethod.call.apply(oldMethod, [_this].concat(Array.prototype.slice.call(_arguments)));
        });
    };
};
...
var replayPromise = function replayPromise(name, oldMethod) {
